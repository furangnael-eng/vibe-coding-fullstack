...
document.getElementById('back-btn').href = `/post/post_detail.html?no=${no}`;
document.getElementById('cancel-btn').href = `/post/post_detail.html?no=${no}`;
...
document.getElementById('post-form').addEventListener('submit', async (e) => {
    ...
    try {
        ...
        if (res.ok) {
            alert('수정되었습니다.');
            location.href = `/post/post_detail.html?no=${no}`;
            return;
        }
